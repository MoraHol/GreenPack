...
<head>
  <title>Dashboard | Crear Pestaña</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<body class="white-edition">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="row" style="margin-bottom: 20px; margin-top: 60px;">
          <div class="col"><a href="/admin/products/update_product.php?id=<?= $_GET["id"] ?>" class="btn btn-danger btn-lg">Regresar</a></div>
  ...
  <script>
    ...
    $('#submitEditor').click(() => {
      $.post('api/create_tab_product.php', {
        idProduct: `<?= $_GET["id"] ?>`,
        title: $('#title').val(),
        content: editor.html.get()
      }, (data, status) => {
        if (status == 'success') {
          location.href = "update_product.php?id=<?= $_GET["id"] ?>"
        }
      })
    })
  </script>
