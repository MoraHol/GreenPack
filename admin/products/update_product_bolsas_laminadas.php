                ...
                <ul class="list-unstyled" id="measurements">
                  <?php foreach ($product->getMeasurements() as $measurement) {
                    ...
                    <li>Medida <?= $indexMeasurement ?>:<div class="row">
                        ...
                        <div class="col">
                          <label for="pliego<?= $indexMeasurement ?>">Pliego</label>
                          <select class="wide disabled" id="pliego<?= $indexMeasurement ?>">
                            <option value="5400" <?= $measurement->getPliego() == 5400 ? "selected" : "" ?>>60*90</option>
                            <option value="7000" <?= $measurement->getPliego() == 7000 ? "selected" : "" ?>>70*100</option>
                          </select>
                        </div>
      ...
      <script>
        ...
        <li>Medida ${indexMeasurement}:
          <div class="row">
            ...
            <div class="col">
                          <label for="pliego${indexMeasurement}">Pliego:</label>
                          <select id="pliego${indexMeasurement}" class="wide">
                            <option value="5400">60*90</option>
                            <option value="7000">70*100</option>
                          </select>
                        </div>
          </div>
        </li>`)
